...
import { BtgrpLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
  describe('LoginComponent', () => {
    let comp: BtgrpLoginModalComponent;
    let fixture: ComponentFixture<BtgrpLoginModalComponent>;
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [BtgrpLoginModalComponent],
        providers: [
          FormBuilder,
          {
        ...
        .overrideTemplate(BtgrpLoginModalComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(BtgrpLoginModalComponent);
