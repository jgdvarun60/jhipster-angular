...
import { BtgrpHealthCheckComponent } from 'app/admin/health/health.component';
import { BtgrpHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
  describe('BtgrpHealthCheckComponent', () => {
    let comp: BtgrpHealthCheckComponent;
    let fixture: ComponentFixture<BtgrpHealthCheckComponent>;
    let service: BtgrpHealthService;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [ProTrackTestModule],
        declarations: [BtgrpHealthCheckComponent]
      })
        .overrideTemplate(BtgrpHealthCheckComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(BtgrpHealthCheckComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(BtgrpHealthService);
    });
